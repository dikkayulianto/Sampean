...
# virtual methods
.method public final B(Lj$/time/temporal/a;)Lj$/time/temporal/r;
    .locals 8
    ...
    .line 229
    invoke-virtual {v5}, Lj$/time/chrono/y;->s()Lj$/time/chrono/y;
    ...
    .line 147
    invoke-static {v3, v4, v0, v1}, Lj$/time/temporal/r;->g(JJ)Lj$/time/temporal/r;
    ...
    .line 147
    invoke-static {v1, v2, v3, v4}, Lj$/time/temporal/r;->g(JJ)Lj$/time/temporal/r;
...
.method public final E(I)Lj$/time/chrono/m;
    .locals 0

    .line 382
    invoke-static {p1}, Lj$/time/chrono/y;->t(I)Lj$/time/chrono/y;
...
.method public final F(Lj$/time/chrono/m;I)I
    ...
    invoke-static {p2}, Lj$/time/chrono/y;->r(Lj$/time/h;)Lj$/time/chrono/y;
...
.method public final J(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
    .locals 1
...
.method public final T(III)Lj$/time/chrono/b;
    .locals 1
...
.method public final V(Ljava/util/Map;Lj$/time/format/x;)Lj$/time/chrono/b;
    ...
    .line 438
    invoke-super {p0, p1, p2}, Lj$/time/chrono/a;->V(Ljava/util/Map;Lj$/time/format/x;)Lj$/time/chrono/b;
...
.method public final W(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 0
...
.method public final Y(Ljava/util/Map;Lj$/time/format/x;)Lj$/time/chrono/b;
    .locals 11
    ...
    .line 447
    invoke-virtual {p0, v0}, Lj$/time/chrono/v;->B(Lj$/time/temporal/a;)Lj$/time/temporal/r;
    ...
    .line 382
    invoke-static {v1}, Lj$/time/chrono/y;->t(I)Lj$/time/chrono/y;
    ...
    .line 452
    invoke-virtual {p0, v3}, Lj$/time/chrono/v;->B(Lj$/time/temporal/a;)Lj$/time/temporal/r;
    ...
    .line 487
    :cond_3
    invoke-virtual {p0, v4}, Lj$/time/chrono/v;->B(Lj$/time/temporal/a;)Lj$/time/temporal/r;
    ...
    .line 488
    invoke-virtual {p0, v7}, Lj$/time/chrono/v;->B(Lj$/time/temporal/a;)Lj$/time/temporal/r;
    ...
    .line 498
    invoke-virtual {p1, p2}, Lj$/time/chrono/x;->c0(Lj$/time/i;)Lj$/time/chrono/x;
    ...
    invoke-interface {v2, p1}, Lj$/time/temporal/TemporalAccessor;->g(Lj$/time/temporal/o;)I
    ...
    .line 234
    invoke-virtual {p1, p2}, Lj$/time/h;->b0(Lj$/time/chrono/b;)Z
    ...
    .line 306
    invoke-virtual {p2}, Lj$/time/h;->Y()I
    ...
    .line 305
    invoke-static {v0, p2}, Lj$/time/h;->i0(II)Lj$/time/h;
