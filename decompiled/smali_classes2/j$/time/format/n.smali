...
# direct methods
.method public constructor <init>(Lj$/time/temporal/o;Lj$/time/format/z;Lj$/time/format/a;)V
    .locals 0
...
.method public final D(Lj$/time/format/p;Ljava/lang/CharSequence;I)I
    ...
    iget-object v6, p0, Lj$/time/format/n;->a:Lj$/time/temporal/o;
    ...
    .line 3355
    iget-object v1, p0, Lj$/time/format/n;->a:Lj$/time/temporal/o;
    ...
    invoke-virtual/range {v0 .. v5}, Lj$/time/format/p;->f(Lj$/time/temporal/o;JII)I
    ...
    .line 3360
    invoke-interface {v7}, Lj$/time/chrono/l;->C()Ljava/util/List;
    ...
    invoke-direct {v1, v2, v6, v3, v5}, Lj$/time/format/h;-><init>(Lj$/time/temporal/o;IILj$/time/format/y;)V
    ...
    .line 3372
    invoke-virtual {v1, p1, p2, p3}, Lj$/time/format/h;->D(Lj$/time/format/p;Ljava/lang/CharSequence;I)I
...
.method public final u(Lj$/time/format/s;Ljava/lang/StringBuilder;)Z
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/h;-><init>(Lj$/time/temporal/o;IILj$/time/format/y;)V
    ...
    .line 3330
    invoke-virtual {v0, p1, p2}, Lj$/time/format/h;->u(Lj$/time/format/s;Ljava/lang/StringBuilder;)Z
