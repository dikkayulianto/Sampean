...
.method public static a(Lj$/time/format/p;Ljava/lang/CharSequence;IILj$/time/format/i;)I
    ...
    .line 4322
    invoke-virtual {p4, v1, p1, p3}, Lj$/time/format/i;->D(Lj$/time/format/p;Ljava/lang/CharSequence;I)I
    ...
    .line 4332
    invoke-static {p3}, Lj$/time/A;->d0(I)Lj$/time/A;

    move-result-object p3

    .line 4333
    invoke-static {v0, p3}, Lj$/time/ZoneId;->K(Ljava/lang/String;Lj$/time/A;)Lj$/time/ZoneId;
...
# virtual methods
.method public final D(Lj$/time/format/p;Ljava/lang/CharSequence;I)I
    .locals 17
    ...
    .line 4286
    sget-object v0, Lj$/time/A;->f:Lj$/time/A;
    ...
    sget-object v9, Lj$/time/format/DateTimeFormatter;->f:Lj$/time/format/DateTimeFormatter;
    ...
    .line 3483
    invoke-virtual {v3, v8, v9}, Lj$/time/format/o;->g(Lj$/time/temporal/o;I)V
    ...
    .line 3484
    invoke-virtual {v3, v11, v9}, Lj$/time/format/o;->g(Lj$/time/temporal/o;I)V
    ...
    .line 3485
    invoke-virtual {v3, v10, v9}, Lj$/time/format/o;->g(Lj$/time/temporal/o;I)V
    ...
    invoke-direct {v12, v9}, Lj$/time/format/f;-><init>(Lj$/time/temporal/o;)V
    ...
    .line 3490
    invoke-virtual {v3, v4, v0, v6}, Lj$/time/format/d;->D(Lj$/time/format/p;Ljava/lang/CharSequence;I)I
    ...
    .line 361
    invoke-static {v4, v3, v14}, Lj$/time/h;->g0(III)Lj$/time/h;

    move-result-object v3

    .line 362
    invoke-static {v8, v11, v10, v5}, Lj$/time/l;->S(IIII)Lj$/time/l;
    ...
    .line 3517
    sget-object v4, Lj$/time/A;->f:Lj$/time/A;

    invoke-interface {v3, v4}, Lj$/time/chrono/e;->z(Lj$/time/A;)J
    ...
    invoke-virtual/range {v2 .. v7}, Lj$/time/format/p;->f(Lj$/time/temporal/o;JII)I
...
.method public final u(Lj$/time/format/s;Ljava/lang/StringBuilder;)Z
    .locals 19
    ...
    .line 4212
    :cond_2
    invoke-virtual {v5}, Lj$/time/ZoneId;->s()Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lj$/time/format/s;->a(Lj$/time/temporal/o;)Ljava/lang/Long;
    ...
    invoke-interface {v0, v4}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/o;)Z
    ...
    .line 3417
    invoke-interface {v0, v4}, Lj$/time/temporal/TemporalAccessor;->i(Lj$/time/temporal/o;)J
    ...
    .line 669
    :goto_3
    iget-object v0, v4, Lj$/time/temporal/a;->d:Lj$/time/temporal/r;

    .line 732
    invoke-virtual {v0, v10, v11, v4}, Lj$/time/temporal/r;->a(JLj$/time/temporal/o;)I
    ...
    .line 3430
    sget-object v3, Lj$/time/A;->f:Lj$/time/A;

    invoke-static {v6, v7, v5, v3}, Lj$/time/LocalDateTime;->S(JILj$/time/A;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v13, v14, v5, v3}, Lj$/time/LocalDateTime;->S(JILj$/time/A;)Lj$/time/LocalDateTime;
